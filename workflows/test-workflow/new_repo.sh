...
# Test Workflow Toolkit — New Repo Scaffolder
...
#
# Examples:
#   ./new_repo.sh my-project                        # Uses $GITHUB_ORG, both editors
#   ./new_repo.sh --org mycompany my-project        # Explicit org
#   ./new_repo.sh --editor cursor my-project        # Cursor only
#   ./new_repo.sh --org myco --editor claude proj   # All flags
