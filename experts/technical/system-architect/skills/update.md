...
If `docs/architecture.md` doesn't exist, tell the user: "No architecture document exists yet. Run the `design` skill to create one, or `/start` to pick up an architect-scoped issue."
