...
If `docs/project-brief.md` doesn't exist, tell the user: "No project brief found. Run `/interview` and the `vision` skill first so I have project context to build on."
...
Tell the user they can run the `pipeline` skill next to define their build/test/deploy pipeline based on this context.
