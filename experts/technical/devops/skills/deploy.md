...
If `docs/release-plan.md` doesn't exist, tell the user: "No release plan found. Run the `release-plan` skill first to define release gates and rollback procedures."
