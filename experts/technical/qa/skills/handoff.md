...
Look at existing files in `docs/handoff-notes/qa/`. The new file should be the next number in sequence (e.g., if `session-02.md` is the latest, create `session-03.md`). If no handoff notes exist, create `session-01.md`.
