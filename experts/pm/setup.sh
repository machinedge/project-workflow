...
echo "  [pm] Installing PM workflow in: $TARGET (editor: $EDITOR)"
...
if [ "$EDITOR" = "claude" ] || [ "$EDITOR" = "both" ]; then
    ...
    cp "$SCRIPT_DIR/editor.md" "$TARGET/.claude/roles/pm.md"
...
echo "    PM commands installed: /interview, /add_feature, /vision, /roadmap, /decompose, /postmortem"
