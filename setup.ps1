# AI Project Toolkit — Setup (Windows)
...
Write-Host "Setting up project toolkit in: $Target (editor: $Editor)"
...
"@
    ...
    ($frontmatter + $editorContent) | Set-Content -Path "$Target/.cursor/rules/project-os.mdc" -Encoding UTF8
