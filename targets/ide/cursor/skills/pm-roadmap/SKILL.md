---
name: pm-roadmap
description: "Create the project milestone plan from the project brief. Use when the project brief exists and the user needs a roadmap with milestones, dependencies, and risks."
---
