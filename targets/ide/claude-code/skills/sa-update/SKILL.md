...
If `docs/architecture.md` doesn't exist, tell the user: "No architecture document exists yet. Run `/sa-design` to create one, or `/sa-start` to pick up an architect-scoped issue."
