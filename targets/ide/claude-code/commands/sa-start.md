...
- If the task requires evaluating technology options, do the evaluation here (same rigor as `/sa-research`)
...
Then ask the user if they'd like to proceed to `/sa-handoff` to close out the session.
