Structured interview to capture the deployment and test environment context. This is the DevOps equivalent of the PM interview — extractive, not prescriptive.
...
**Source:** `/ops-env-discovery` interview
