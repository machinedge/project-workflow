...
2. Read `docs/data-profile.md` (understand what's known about the data so far)
3. Read `docs/lessons-log.md` (skim for relevant entries)
4. Read the GitHub issue you've been assigned (or check the brief's "Next task" field)
5. Read the most recent handoff note in `docs/handoff-notes/`
6. Confirm your understanding of the task before starting work
...
- `/intake` — Structured interview to understand the data, domain, and business questions
