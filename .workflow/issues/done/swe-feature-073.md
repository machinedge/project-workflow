...
**What was done:** Updated all three documentation files (agent-reference.md, Cursor README, Claude Code README) to replace stale `docs/handoff-notes/`, `docs/lessons-log.md`, and `issues/` references with `.workflow/` equivalents.
