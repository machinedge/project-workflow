...
Updated all 6 Cursor rule files in `targets/ide/cursor/rules/` to replace old artifact paths (`docs/handoff-notes/`, `docs/lessons-log.md`, `docs/interview-notes*`, `issues/`) with their `.workflow/` equivalents per ADR-011. This is the first implementation step of M13 (Workflow Directory).

## Acceptance Criteria Status
- [x] `project-os.mdc` conventions section references `.workflow/handoff-notes/` and `.workflow/issues/`
- [x] `project-manager-os.mdc` references `.workflow/` for handoff notes, interview notes, and issues paths
- [x] `swe-os.mdc` references `.workflow/` for handoff notes, lessons-log, and issues paths
- [x] `qa-os.mdc` references `.workflow/` for handoff notes, lessons-log, and issues paths
- [x] `devops-os.mdc` references `.workflow/` for handoff notes and lessons-log paths
- [x] `system-architect-os.mdc` references `.workflow/` for handoff notes and lessons-log paths
