...
Updated `CLAUDE.md` and all 5 Claude Code role files in `targets/ide/claude-code/roles/` to replace old artifact paths (`docs/handoff-notes/`, `docs/lessons-log.md`, `docs/interview-notes*`, `issues/`) with their `.workflow/` equivalents per ADR-011. This completes step 1 (conventions/roles) of the M13 implementation order for both platforms.

## Acceptance Criteria Status
- [x] `CLAUDE.md` conventions section references `.workflow/handoff-notes/` and `.workflow/issues/`
- [x] `project-manager.md` references `.workflow/` for handoff notes, interview notes, and issues paths
- [x] `swe.md` references `.workflow/` for handoff notes, lessons-log, and issues paths
- [x] `qa.md` references `.workflow/` for handoff notes, lessons-log, and issues paths
- [x] `devops.md` references `.workflow/` for handoff notes and lessons-log paths
- [x] `system-architect.md` references `.workflow/` for handoff notes and lessons-log paths
