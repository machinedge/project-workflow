...
- **Last completed:** swe-bug-019 (removed broken doc links to overview.md, getting-started.md, workflow-anatomy.md)
- **Blockers:** None
- **Next task:** swe-bug-023 (PM decompose skill missing Prerequisites column); qa-feature-005 (QA consistency review)
