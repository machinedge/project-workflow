...
3. Most recent handoff note in `docs/handoff-notes/qa/` (if any exist) — understand recent QA activity
...
Run `.cursor/scripts/update-issues-list.sh` to regenerate `issues/issues-list.md` with updated severity assignments.
