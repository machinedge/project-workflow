...
For must-fix and should-fix findings, create issue files in `issues/backlog/`. Run `.cursor/scripts/next-issue-number.sh` for the next available number.
...
Run `.cursor/scripts/update-issues-list.sh` after creating issues.
