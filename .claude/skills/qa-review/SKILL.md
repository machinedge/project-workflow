...
Run `.claude/scripts/next-issue-number.sh` to get the next available issue number.
...
- Run `.claude/scripts/update-issues-list.sh` to regenerate `.workflow/issues/issues-list.md`
