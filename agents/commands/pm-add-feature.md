...
- Save the summary to `.sdlc/rview-notes-[short-slug].md` (e.g. `.sdl.sdlc/w-notes-dark-mode.md`). Use a short, descriptive slug based on what the user describes.
