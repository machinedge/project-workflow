...
If the deployment failed or was rolled back, create an issue file in `.workflow/issues/backlog/`. Run `.agents/scripts/next-issue-number.sh` for the next number.
