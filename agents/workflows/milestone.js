...
if (stage === 'postmortem') {
  ...
  return {
    ...
    postmortem: pm,
    nextGate: 'Postmortem gate — present the honest assessment in the pm-postmortem presentation layout (bottom line first, plain language, IDs expanded — see "Speaking to the user" in AGENTS.md) along with the drafted doc updates (project-brief, roadmap, lessons-log) for the user to review and approve. After approval, the docs are the record of the closed milestone; write the expert handoff notes (team-milestone Phase 6, step 4) for the experts that did substantive work.',
  }
}
