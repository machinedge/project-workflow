...
Save to `.sdlc/handoff-notes/system-architect/session-NN.md`:
...
**Handoff note:** `.sdlc/handoff-notes/system-architect/session-NN.md`
...
If anything was learned during this session (a gotcha, an architectural pattern, a technical quirk), add it to `.sdlc/lessons-log.md`.
