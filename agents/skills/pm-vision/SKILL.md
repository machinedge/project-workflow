---
name: pm-vision
description: "Generate the project brief from interview notes. Use when the user has completed a project interview (/pm-interview) and needs the raw notes transformed into a structured project brief."
---

Generate the project brief from interview notes.

First, read `.sdlc/interview-notes.md`. If it doesn't exist, ask the user to run `/pm-interview` first or provide project details.
...
Also create an empty `.sdlc/lessons-log.md` from the template if it doesn't exist.
