---
name: pm-update-plan
description: "Update the project brief and roadmap with a newly scoped feature. Use after a feature interview (/pm-add-feature) when the user needs the new feature integrated into existing planning artifacts."
---
...
3. The most recent `.sdlc/interview-notes-*.md` file (by modification date), or the one the user specifies.

If no feature interview notes exist (`.sdlc/interview-notes-*.md`), tell the user to run `/pm-add-feature` first.
